...
.. glossary::
  ...
  prototype
    An instance of an Agent that is created from a simulation input
    file. Instances of the Agent type that are built inside of a simulation are
    cloned from the original prototype.
